# Jux's home-manager configuration
...
- `secret.nix` is not included, because it's a secret :3. Remove it from `flake.nix` or add it and do whatever you want with it.
